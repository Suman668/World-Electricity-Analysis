...
Select count(case when _1990>=75 then 1 else 0 end) as _1990s from rular_world
...
select region,sum(_1990+_1991+_1992+_1993+_1994+_1995+_1996+_1997+_1998+_1999+_2000+_2001 + _2002+ _2003 + _2004  + _2005 + _2006 + _2007 
+ _2008 + _2009 + _2010  + _2011 + _2012 + _2013 + _2014 + _2015 ) as Nueclear_Energy_Production  from metadata_country_code as mcc  join nuclear_sources as ns on ns.Country_Code = mcc.country_code
group by region
having region  is not null

Select IncomeGroup,Round(Sum(_1990+_1991+_1992+_1993+_1994+_1995+_1996+_1997+_1998+_1999+_2000+_2001 + _2002+ _2003 + _2004  + _2005 + _2006 + _2007 
...
having IncomeGroup  is not null
